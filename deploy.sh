...
Dragon Warrior v6 -Base Aiogram
(C) 2020-2021 by @TEAMShadowZ
Support Chat is @DragonWarriorSUPPORT.
...
=++---------------------------------------------++=
Dragon Warrior. Deployed Successfully

 ***************************
 * |D| |W| |A| |R| |R| |I| |O| |R| *
 ******************* v6.0 ** 

Thanks for deploying Dragon Warrior
(C) 2020-2021 by @TEAMShadowZ
Support Chat is @DragonWarriorSUPPORT.
=++---------------------------------------------++=
